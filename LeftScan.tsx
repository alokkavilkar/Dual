...
import { Alert, Button, FlatList, PermissionsAndroid, Platform, Text, ToastAndroid, TouchableHighlight, TouchableOpacity, View } from 'react-native'
...
export function LeftScan({ navigation }: { navigation: any }) {

    console.log("Left Page Loaded")
        ...
        const AsyncData = () => {
            AsyncStorage.getItem("@app:id").then((val)=>{
                ...
                if(val !== "null" && val !== null)
                {
                    ...
                    ToastAndroid.show("Already Paired....", ToastAndroid.SHORT);
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity
                style={{ width: '90%', backgroundColor: '#000bff', margin: 20, padding: 20, borderRadius: 20 }}
                onPress={enableBLE}
            >
            ...
            <FlatList style={{ width: '90%' }}
                ...
                renderItem={item => (
                    <TouchableHighlight
                        ...
                        onPress={() => {
                            navigation.navigate("Left Watch Connect", { id: item.item.id, name: item.item.name });
                            ...
                            if(item.item.name)
                            {
                                ...
                                AsyncStorage.setItem("@app:myname", item.item.name);
                            }
